...
class TestSchemaInference:
    ...
    def test_project_unary_expressions(self):
        ...
        exprs = [
            ...
            UnaryExpr(Operation.NE, col("value")).alias("neg_value")
        ]
        project = Project(mock_input, exprs)
        ...
        assert result_schema.field("neg_value").type == pa.bool_()
    ...
    def test_project_download_expressions(self):
        ...
        exprs = [
            DownloadExpr(ColumnExpr("url")).alias("downloaded_content"),
            ColumnExpr("filename")
        ]
        project = Project(mock_input, exprs)
